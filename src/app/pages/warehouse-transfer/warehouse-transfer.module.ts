...
import { TranferPackageComponent } from './tranfer-package/tranfer-package.component';

@NgModule({
  declarations: [
    ListWarehouseTransferComponent,
    WarehouseTransferDetailComponent,
    CreateWarehouseTransferComponent,
    AddWarehouseTransferComponent,
    ListWarehouseTransferNoteComponent,
    WarehouseTransferNoteDetailComponent,
    TranferPackageComponent,
  ],
  imports: [
    CommonModule,

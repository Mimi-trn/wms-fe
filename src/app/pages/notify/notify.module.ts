...
import { NotifyQuickComponent } from './notify-quick/notify-quick.component';
import { SharedModule } from 'src/app/shared/components/upload/components.module';

@NgModule({
  declarations: [NotifyCommonComponent, NotifyQuickComponent],
  imports: [
    CommonModule,
    NotifyRoutingModule,
    // ng-zorro

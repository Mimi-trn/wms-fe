...
import { InventorySituationDetailComponent } from './inventory-situation/inventory-situation-detail/inventory-situation-detail.component';
...
@NgModule({
  declarations: [
    ...
    InventorySituationComponent,
    InventorySituationDetailComponent,

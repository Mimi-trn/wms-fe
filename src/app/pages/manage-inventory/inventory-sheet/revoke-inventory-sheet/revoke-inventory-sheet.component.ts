...
@Component({
  selector: 'app-revoke-inventory-sheet',
  templateUrl: './revoke-inventory-sheet.component.html',
  styleUrls: ['./revoke-inventory-sheet.component.css'],
})
export class RevokeInventorySheetComponent implements OnInit {

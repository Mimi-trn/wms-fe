...
import { StorageWarehouseRoutingModule } from './storage-warehouse-routing.module';
...
@NgModule({
  declarations: [
    StorageWarehouseComponent,
    ViewStorageComponent,
    PickingWarehouseComponent,
  ],
  imports: [
    CommonModule,
    StorageWarehouseRoutingModule,
    // ng-zorro
    NzAffixModule,
    NzAlertModule,
    NzAnchorModule,
...
export class StorageWarehouseModule {}

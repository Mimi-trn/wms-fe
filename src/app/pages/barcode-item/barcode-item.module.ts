import { BarcodeItemChildComponent } from './barcode-item-child/barcode-item-child.component';
...
import { BarcodeItemRoutingModule } from './barcode-item-routing.module';
...
@NgModule({
  declarations: [
    ...
    BarcodeItemChildComponent,
    ReadQrCodeComponent,
    CreateQrCodeComponent,
  ],
  imports: [
    CommonModule,
    BarcodeItemRoutingModule,
    // ng-zorro
    NzAffixModule,
    NzAlertModule,
    NzAnchorModule,
...
export class BarcodeItemModule {}

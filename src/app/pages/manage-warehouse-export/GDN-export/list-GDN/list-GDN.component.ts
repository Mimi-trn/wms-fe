...
@Component({
  selector: 'app-list-GDN',
  templateUrl: './list-GDN.component.html',
  styleUrls: ['./list-GDN.component.css'],
})
export class ListGDNComponent implements OnInit {
  constructor(
  ...
  ngOnInit() {
    this.selectedProductType = this.listProductType[0].value;
    ...
    this.columns = [
      ...
      {
        keyTitle: 'sidebar.export.child.goodDeliveryNote.child.status',
        keyName: 'status',
        width: '180px',
        check: false,
      },
      ...
      if (
        ...
        data = {
          ...
          filter: {
            ...
            productType:
              this.selectedProductType == '' ? null : this.selectedProductType,
            woCode: this.dataFilter.woCode,
            exportTypeId: this.dataFilter.exportTypeId,
          },
  ...
  handleSelectProductType(event: any) {
    this.getListGDN();
  }

...
@Component({
  selector: 'app-grn-revoke',
  templateUrl: './grn-revoke.component.html',
  styleUrls: ['./grn-revoke.component.css']
})
export class GrnRevokeComponent implements OnInit {
  ...
  async confirm() {
    if (!this.reason) {
      ...
      let resp = await this.reasonService.postRevoke(data);
